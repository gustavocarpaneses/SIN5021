...
namespace Planejamento.Problemas
{
    ...
    */
    static class LinhaDetLinhaProb
    {
        ...
        {
            double[][] transicaoNorte = new double[10][];

            for (int i = 0; i < 10; i++)
                transicaoNorte[i] = new double[10];
            ...
            double[][] transicaoLeste = new double[10][];

            for (int i = 0; i < 10; i++)
                transicaoLeste[i] = new double[10];
            ...
            double[][] transicaoOeste = new double[10][];

            for (int i = 0; i < 10; i++)
                transicaoOeste[i] = new double[10];
            ...
            double[][] transicaoSul = new double[10][];

            for (int i = 0; i < 10; i++)
                transicaoSul[i] = new double[10];
